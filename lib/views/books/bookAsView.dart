...
class _BookAsViewState extends State<BookAsView> {
  List<String> bookName = [
      ...
      bookGroup = ['ສາຍທຳມະຊາດ', 'ສາຍສັງຄົມ', 'ສາຍທຳມະຊາດ', 'ສາຍທຳມະຊາດ'],
      yearPrint = ['2020', '2020', '2021', '2019'];
  ...
  List<int> bookId = [1, 2, 3, 4],
      totalView = [1, 2, 3, 4],
      totalLike = [1, 2, 3, 4],
      totalDownload = [1, 2, 3, 4];
  List<bool> isLike = [false, false, false, false],
      isBookmark = [false, false, false, false];
  // void iniState() async {
  //   setState(() {
  //     view = Setting.view.toString();
  //   });
  // }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(
        title: 'ບົດທີ່ມີຍອດ view Top: ' + Setting.view.toString(),
        fontSize: 20,
        onActionPress: () {},
      ).myAppBar(),
      body: Container(
